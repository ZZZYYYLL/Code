...
if __name__ == "__main__":
    input_image = Image.open("/root/autodl-tmp/SAM/notebooks/images/866.jpg")
    # target_age_list = [0,20,40,60,80,100]
    result_image_total = process_multi(input_image, 0,20,40,60,80,100)
    input_image.save("input_image.jpg")
    for i, result_img in enumerate(result_image_total):
        print("age: ", i)
        result_img.save("result_image_{}.jpg".format(i))
